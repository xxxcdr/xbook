...
const cn = {
  ...
  Chat: {
    SubTitle: (count: number) => "回复由AI语言模型生成", //`与 小林同学 的 ${count} 条对话`, //对话框最上方与ChatGPT对话的位置的更改为GPTMAN，导入聊天记录在下面43行
    Actions: {
      ChatList: "查看消息列表",
  ...
  Export: {
    ...
    MessageFromChatGPT: "来自 ChatBOOK 的消息", //导出聊天记录需要更改发言人ChatGPT为 GPTMAN
  },
  Memory: {
    Title: "历史摘要",
