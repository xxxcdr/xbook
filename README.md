...
- 隐私安全，所有数据保存在用户浏览器本地
- 预制AI-Book功能（AI-Book），方便地创建、分享和调试你的个性化对话
...
- [x] 预制AI-Book：使用预制AI-Book快速定制新对话 [#993](https://github.com/Yidadaa/ChatGPT-Next-Web/issues/993)
- [ ] 分享为图片，分享到 ShareGPT
- [ ] 使用 tauri 打包桌面应用
- [ ] 支持自部署的大语言模型
...
## 最新动态
- 🚀 v2.0 已经发布，现在你可以使用AI-Book功能快速创建预制对话了！ 了解更多： [ChatGPT 提示语高阶技能：零次、一次和少样本提示](https://github.com/Yidadaa/ChatGPT-Next-Web/issues/138)。
