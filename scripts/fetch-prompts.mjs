...
const jsonTemp = [
  {
    "cn": [
      [
        "基础",
        "我要如何向你提问，才能最大限度地利用这本书中的知识，请直接给我问题供我参考，谢谢。\n"
      ],
      [
        "基础",
        "请帮我举个例子讲解，谢谢。\n"
      ...
      [
        "进阶",
        "请针对上述内容用辩论的形式展现，帮助我从正反双方的观点中增强理解，请不少于3个回合的辩论，最后请小林同学结辩，并记得提出你的灵魂拷问，谢谢。\n"
      ],
      [
        "进阶",
        "请你扮演3位对这个问题具有深度见解的历史名人，用第一人称表达，请模仿他们的表达方式和思维习惯，请确保回答具有深度和针对性，最后请小林同学总结发言，并记得提出你的灵魂拷问，谢谢。\n"
      ],
      [
        "进阶",
        "请你扮演一位教练，运用此书的理论知识，向我提问或采访，辅助我解决实际问题。请一次只问我一个核心问题，谢谢。\n"
      ],
      [
        "进阶",
        "请针对我的提问，帮我解读我的用意，帮我厘清其中的用字谴词，可能我不知道自己有一些潜在需求，谢谢你的协助。\n"
      ]
